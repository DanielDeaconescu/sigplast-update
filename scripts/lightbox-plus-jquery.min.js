!(function (e, t) {
  ...
  function f() {
    ee.removeEventListener("DOMContentLoaded", f),
  ...
  function p(e) {
    return e.replace(je, "ms-").replace(Ie, d);
  }
  function h() {
  ...
  function w(e, t, n, i, o) {
    for (
      ...
      if ((a = e[h]) || 0 === a)
        if ("object" === r(a)) ge.merge(p, a.nodeType ? [a] : a);
        else if (Ye.test(a)) {
          for (
            s = s || d.appendChild(t.createElement("div")),
              u = (Ve.exec(a) || ["", ""])[1].toLowerCase(),
              l = Qe[u] || Qe._default,
            ...
            s = s.lastChild;
          ge.merge(p, s.childNodes), ((s = d.firstChild).textContent = "");
        } else p.push(t.createTextNode(a));
    for (d.textContent = "", h = 0; (a = p[h++]); )
      if (i && ge.inArray(a, i) > -1) o && o.push(a);
      else if (((c = Be(a)), (s = b(d.appendChild(a), "script")), c && x(s), n))
        for (f = 0; (a = s[f++]); ) Ge.test(a.type || "") && n.push(a);
    return d;
  }
  function T() {
    return !0;
  ...
  function E(e, t, n) {
    n
        ...
        ge.event.add(e, t, {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              ...
              o.length &&
                (qe.set(this, t, {
                  value: ge.event.trigger(
                    ge.extend(o[0], ge.Event.prototype),
                    o.slice(1),
                    this
                  ),
                }),
      ...
      : void 0 === qe.get(e, t) && ge.event.add(e, t, T);
  }
  function N(e, t) {
    return (
      (o(e, "table") &&
  ...
  function j(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        qe.hasData(e) &&
        ((o = qe.access(e)), (a = qe.set(t, o)), (l = o.events))
      )
        for (i in (delete a.handle, (a.events = {}), l))
          for (n = 0, r = l[i].length; n < r; n++) ge.event.add(t, i, l[i][n]);
      $e.hasData(e) &&
        ((s = $e.access(e)), (u = ge.extend({}, s)), $e.set(t, u));
    }
  }
  function I(e, t) {
  ...
  function L(e, t, r, i) {
    ...
    var o,
      ...
      h = t[0],
      g = de(h);
    if (g || (d > 1 && "string" == typeof h && !fe.checkClone && nt.test(h)))
    ...
    if (
      ...
      for (u = (s = ge.map(b(o, "script"), S)).length; f < d; f++)
        (l = o),
          f !== p &&
            ((l = ge.clone(l, !0, !0)), u && ge.merge(s, b(l, "script"))),
          r.call(e[f], l, f);
      if (u)
        for (c = s[s.length - 1].ownerDocument, ge.map(s, D), f = 0; f < u; f++)
          (l = s[f]),
            Ge.test(l.type || "") &&
  ...
  function q(e, t, n) {
    for (var r, i = t ? ge.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || ge.cleanData(b(r)),
        r.parentNode &&
          (n && Be(r) && x(b(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  function $(e, t, n) {
    var r,
    ...
    return (
      ...
      (e in ut
        ...
        : (lt[e] =
            (function (e) {
              for (
                var t = e[0].toUpperCase() + e.slice(1), n = st.length;
                n--;
  ...
  function R(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (u += ge.css(e, n + Me[a], !0, i)),
        r
          ? ("content" === n && (u -= ge.css(e, "padding" + Me[a], !0, i)),
            "margin" !== n &&
              (u -= ge.css(e, "border" + Me[a] + "Width", !0, i)))
          : ((u += ge.css(e, "padding" + Me[a], !0, i)),
            "padding" !== n
              ? (u += ge.css(e, "border" + Me[a] + "Width", !0, i))
              : (s += ge.css(e, "border" + Me[a] + "Width", !0, i)));
    return (
      !r &&
        o >= 0 &&
        (u +=
  ...
  function M(e, t, n) {
    ...
    return (
      ((!fe.boxSizingReliable() && i) ||
        "auto" === a ||
        (!parseFloat(a) && "inline" === ge.css(e, "display", !1, r))) &&
        e.getClientRects().length &&
        ((i = "border-box" === ge.css(e, "boxSizing", !1, r)),
        (o = s in e) && (a = e[s])),
      (a = parseFloat(a) || 0) +
        R(e, t, n || (i ? "border" : "content"), o, r, a) +
        "px"
    );
  }
  ...
  function B() {
    gt &&
      (!1 === ee.hidden && e.requestAnimationFrame
        ? e.requestAnimationFrame(B)
        : e.setTimeout(B, ge.fx.interval),
      ge.fx.tick());
  }
  function F() {
    return (
  ...
  (ge.fn = ge.prototype =
    ...
    "function" == typeof Symbol &&
      (ge.fn[Symbol.iterator] = Z[Symbol.iterator]),
    ge.each(
  ...
  var ve = (function (e) {
      ...
      return (
        ...
        r(function (r, a, s, u) {
          var l,
            ...
            b = n ? (o || (r ? e : h || i) ? [] : a) : y;
          if ((n && n(y, b, s, u), i))
            for (l = v(b, p), i(l, [], s, u), c = l.length; c--; )
              (f = l[c]) && (b[p[c]] = !(y[p[c]] = f));
          if (r) {
            if (o || e) {
              if (o) {
          ...
          } else (b = v(b === a ? b.splice(h, b.length) : b)), o ? o(null, a, b, u) : Z.apply(a, b);
        })
      );
    }
    function b(e) {
      ...
      var i = n.length > 0,
        ...
        a = function (r, a, s, u, l) {
          ...
          for (
            ...
            if (o && c) {
              for (
                f = 0, a || c.ownerDocument === q || (L(c), (s = !H));
                (d = e[f++]);
    ...
    try {
      Z.apply((Y = ee.call(B.childNodes)), B.childNodes),
      ...
      function (e) {
        ...
        return r !== q && 9 === r.nodeType && r.documentElement
          ? (($ = (q = r).documentElement),
            ...
            (T.getElementsByClassName = ye.test(q.getElementsByClassName)),
            ...
            (P = []),
            (O = []),
            (T.qsa = ye.test(q.querySelectorAll)) &&
              (i(function (e) {
            ...
            (t = ye.test($.compareDocumentPosition)),
            (M =
              t || ye.test($.contains)
                ? function (e, t) {
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!T.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === q || (e.ownerDocument === B && M(B, e))
                        ? -1
                        : t === q || (t.ownerDocument === B && M(B, t))
                        ? 1
                        : j
                        ? te(j, e) - te(j, t)
                        : 0
    ...
    return (
            ...
            for (
              ...
              if (
                ...
                (r = u(
                  ...
                  (xe.test(o[0].type) && f(t.parentNode)) || t
                ))
              ) {
      ...
      (T.sortStable = W.split("").sort(G).join("") === W),
      (T.detectDuplicates = !!I),
      L(),
  ...
  (ge.find = ve),
    (ge.expr = ve.selectors),
    (ge.expr[":"] = ge.expr.pseudos),
    (ge.uniqueSort = ge.unique = ve.uniqueSort),
    (ge.text = ve.getText),
    (ge.isXMLDoc = ve.isXML),
    (ge.contains = ve.contains),
    (ge.escapeSelector = ve.escape);
  ...
  (ge.filter = function (e, t, n) {
    ...
    ge.fn.extend({
      ...
      is: function (e) {
        return !!a(
          this,
          "string" == typeof e && xe.test(e) ? ge(e) : e || [],
          !1
        ).length;
      },
    });
    ...
    if (((n = n || Te), "string" == typeof e)) {
      ...
      if (r[1]) {
        if (
          ...
          ge.merge(
            this,
            ge.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ee, !0)
          ),
          we.test(r[1]) && ge.isPlainObject(t))
        )
          for (r in t) de(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
        return this;
      }
      return (
        (i = ee.getElementById(r[2])) && ((this[0] = i), (this.length = 1)),
        this
      );
    }
    return e.nodeType
      ...
      function (e, t) {
        ge.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (Ae[e] || ge.uniqueSort(i), ke.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
    ...
    e =
      "string" == typeof e
        ? (function (e) {
            var t = {};
            return (
              ge.each(e.match(Ee) || [], function (e, n) {
                t[n] = !0;
              }),
              t
            );
        ...
        var n = [
          ...
          i = {
            ...
            then: function (t, r, i) {
              ...
              return ge
                .Deferred(function (e) {
                  n[0][3].add(o(0, e, de(i) ? i : u, e.notifyWith)),
                    n[1][3].add(o(0, e, de(t) ? t : u)),
                    n[2][3].add(o(0, e, de(r) ? r : l));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        var t = arguments.length,
          ...
          a = function (e) {
            return function (n) {
              (r[e] = this),
                (i[e] = arguments.length > 1 ? ne.call(arguments) : n),
                --t || o.resolveWith(r, i);
            };
          };
        if (
    ...
    ge.extend({
      ...
      ready: function (e) {
        (!0 === e ? --ge.readyWait : ge.isReady) ||
          ((ge.isReady = !0),
          (!0 !== e && --ge.readyWait > 0) || Se.resolveWith(ee, [ge]));
      },
    }),
    (ge.ready.then = Se.then),
    "complete" === ee.readyState ||
    ("loading" !== ee.readyState && !ee.documentElement.doScroll)
      ? e.setTimeout(ge.ready)
      : (ee.addEventListener("DOMContentLoaded", f),
  ...
  var De = function (e, t, n, i, o, a, s) {
      var u = 0,
        ...
        c = null == n;
      if ("object" === r(n))
        for (u in ((o = !0), n)) De(e, t, u, n[u], !0, a, s);
      else if (
        void 0 !== i &&
        ((o = !0),
        de(i) || (s = !0),
    ...
    ge.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = $e.get(o)), 1 === o.nodeType && !qe.get(o, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                0 === (r = a[n].name).indexOf("data-") &&
                ((r = p(r.slice(5))), g(o, r, i[r]));
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!r || Array.isArray(n)
                ? (r = qe.access(e, t, ge.makeArray(n)))
                : r.push(n)),
            r || []
          );
      },
  ...
  We.getRootNode &&
    (Be = function (e) {
      return (
        ge.contains(e.ownerDocument, e) || e.getRootNode(Fe) === e.ownerDocument
      );
    });
  var ze = function (e, t) {
      return (
        "none" === (e = t || e).style.display ||
        ("" === e.style.display && Be(e) && "none" === ge.css(e, "display"))
      );
    },
    _e = function (e, t, n, r) {
      var i,
  ...
  (ge.event = {
      ...
      if (m)
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            i && ge.find.matchesSelector(We, i),
        ...
        for (l = (t = (t || "").match(Ee) || [""]).length; l--; )
          if (
            ...
            a &&
              ...
              delete u[p]);
          } else for (p in u) ge.event.remove(e, p + t[l], n, r, !0);
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = ge.event.handlers.call(this, s, l), t = 0;
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            Xe.test(t.type) && t.click && o(t, "input") && E(t, "click", T), !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            Xe.test(t.type) && t.click && o(t, "input") && E(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  ge.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (a = b(s), r = 0, i = (o = b(e)).length; r < i; r++) I(o[r], a[r]);
      if (t)
        if (n)
          for (o = o || b(e), a = a || b(s), r = 0, i = o.length; r < i; r++)
            j(o[r], a[r]);
        else j(e, s);
      return (a = b(s, "script")).length > 0 && x(a, !u && b(e, "script")), s;
    },
    ...
    ge.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (ge.cleanData(b(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return De(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !tt.test(e) &&
              !Qe[(Ve.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = ge.htmlPrefilter(e);
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (ge.cleanData(b(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return L(
          ...
          function (t) {
            ...
            ge.inArray(this, e) < 0 &&
              (ge.cleanData(b(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
    ...
    function t() {
      if (l) {
        (u.style.cssText =
          ...
          We.appendChild(u).appendChild(l);
  ...
  ge.extend({
    ...
    (ge.cssHooks.marginLeft = H(fe.reliableMarginLeft, function (e, t) {
      if (t)
        return (
  ...
  (ge.Animation = ge.extend(U, {
      ...
      function (e, t, n) {
        ...
        if ((u = !ge.isEmptyObject(t)) || !ge.isEmptyObject(p))
          for (r in (f &&
            ...
            null == (l = m && m.display) && (l = qe.get(e, "display")),
          ...
          p))
            u ||
              (m
                ...
                : (m = qe.access(e, "fxshow", {
                    display: l,
                  })),
              o && (m.hidden = !g),
              g && y([e], !0),
              d.done(function () {
                for (r in (g || y([e]), qe.remove(e, "fxshow"), p))
                  ge.style(e, r, p[r]);
              })),
              (u = _(g ? m[r] : 0, r, d)),
              r in m ||
    ...
    (ge.speed = function (e, t, n) {
      ...
      return (
        ...
        (r.old = r.complete),
        (r.complete = function () {
          de(r.old) && r.old.call(this), r.queue && ge.dequeue(this, r.queue);
        }),
        r
      );
    }),
    ...
    (function () {
      ...
      (e.type = "checkbox"),
        ...
        ((e = ee.createElement("input")).value = "t"),
        (e.type = "radio"),
  ...
  ge.fn.extend({
    attr: function (e, t) {
      return De(this, ge.attr, e, t, arguments.length > 1);
    },
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === o && ge.isXMLDoc(e)) ||
                (i =
                  ...
                  (ge.expr.match.bool.test(t) ? yt : void 0)),
              void 0 !== n
                ? null === n
  ...
  ge.fn.extend({
    prop: function (e, t) {
      return De(this, ge.prop, e, t, arguments.length > 1);
    },
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && r
          ...
          : this.each(function () {
              var t, i, o, a;
              if (r)
                for (i = 0, o = ge(this), a = G(e); (t = a[i++]); )
                  o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = V(this)) && qe.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  ge.extend(ge.event, {
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !f.noBubble && !pe(r)) {
          for (
            u = f.delegateType || h, Ct.test(u + h) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            p.push(a), (s = a);
          s === (r.ownerDocument || ee) &&
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              t.isPropagationStopped() && d.addEventListener(h, kt),
              r[h](),
              t.isPropagationStopped() && d.removeEventListener(h, kt),
            ...
            l
              ? (h.ifModified &&
                ...
                204 === t || "HEAD" === h.type
                  ...
                  : 304 === t
                  ? (T = "notmodified")
                  : ((T = x.state), (d = x.data), (l = !(p = x.error))))
              : ((p = T), (!t && T) || ((T = "error"), t < 0 && (t = 0))),
            (C.status = t),
            (C.statusText = (n || T) + ""),
            l ? v.resolveWith(g, [d, T, C]) : v.rejectWith(g, [C, T, p]),
            C.statusCode(b),
            (b = void 0),
            f && m.trigger(l ? "ajaxSuccess" : "ajaxError", [C, h, l ? d : p]),
            y.fireWith(g, [C, T]),
            f &&
        ...
        h.hasContent
          ...
          : ((p = h.url.slice(o.length)),
            h.data &&
              ...
              ((o += (Nt.test(o) ? "&" : "?") + h.data), delete h.data),
            !1 === h.cache &&
              ((o = o.replace($t, "$1")),
              (p = (Nt.test(o) ? "&" : "?") + "_=" + Et++ + p)),
            (h.url = o + p)),
  ...
  (fe.cors = !!zt && "withCredentials" in zt),
    (fe.ajax = zt = !!zt),
    ge.ajaxTransport(function (t) {
      var n, r;
      if (fe.cors || (zt && !t.crossDomain))
        return {
          send: function (i, o) {
            var a,
              s = t.xhr();
  ...
  ge.ajaxSetup({
    ...
    (ge.fn.load = function (e, t, n) {
      var r,
        ...
        s = e.indexOf(" ");
      return (
        s > -1 && ((r = X(e.slice(s))), (e = e.slice(0, s))),
        de(t)
          ? ((n = t), (t = void 0))
        ...
        ge.fn[e] = function (r) {
          return De(
            ...
            function (e, r, i) {
              var o;
              if (
                (pe(e) ? (o = e) : 9 === e.nodeType && (o = e.defaultView),
                void 0 === i)
              )
                return o ? o[t] : e[r];
              o
    ...
    ge.each(["top", "left"], function (e, t) {
      ge.cssHooks[t] = H(fe.pixelPosition, function (e, n) {
        if (n)
          return (n = $(e, t)), it.test(n) ? ge(e).position()[t] + "px" : n;
      });
    }),
    ge.each(
      {
  ...
  return (
    (ge.noConflict = function (t) {
      return (
        e.$ === ge && (e.$ = Vt), t && e.jQuery === ge && (e.jQuery = Xt), ge
      );
    }),
    t || (e.jQuery = e.$ = ge),
    ge
  ...
  (function (e, t) {
    ...
    return (
      ...
      (t.prototype.start = function (t) {
        ...
        var r = this,
          i = e(window);
        i.on("resize", e.proxy(this.sizeOverlay, this)),
          this.sizeOverlay(),
          (this.album = []);
        var o,
          a = 0,
        ...
        this.$lightbox
          ...
          this.options.disableScrolling &&
            e("body").addClass("lb-disable-scrolling"),
          this.changeImage(a);
      }),
        ...
        (a.onload = function () {
          ...
          o.attr({
            ...
            (l =
              ...
              n.options.positionFromTop -
              70),
            "svg" === i && (o.width(c), o.height(l)),
            n.options.fitImagesInViewport
              ? (n.options.maxWidth &&
                  n.options.maxWidth < c &&
                  (c = n.options.maxWidth),
                n.options.maxHeight &&
                  n.options.maxHeight < l &&
                  (l = n.options.maxHeight))
              : ((c = n.options.maxWidth || a.width || c),
                (l = n.options.maxHeight || a.height || l)),
            (a.width > c || a.height > l) &&
              (a.width / c > a.height / l
                ? ((u = c),
                  (s = parseInt(a.height / (a.width / u), 10)),
                  o.width(u),
                  o.height(s))
                : ((s = l),
                  (u = parseInt(a.width / (a.height / s), 10)),
                  o.width(u),
                  o.height(s))),
      ...
      (t.prototype.sizeContainer = function (e, t) {
        function n() {
          r.$lightbox.find(".lb-dataContainer").width(a),
            r.$lightbox.find(".lb-prevLink").height(s),
            r.$lightbox.find(".lb-nextLink").height(s),
            r.$overlay.focus(),
            r.showImage();
        }
        var r = this,
      ...
      (t.prototype.end = function () {
        this.disableKeyboardNav(),
          ...
          this.options.disableScrolling &&
            e("body").removeClass("lb-disable-scrolling");
      }),
      new t()
    );
  });
